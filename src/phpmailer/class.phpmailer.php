...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'sistemas@bateriaswillard.com';
   ...
   * @var string
   */
  public $Hostname          = 'mail.bateriaswillard.com';
   ...
   * @var string
   */
  public $Host          = 'mail.bateriaswillard.com';
   ...
   * @var string
   */
  public $Username      = 'sistemas@bateriaswillard.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'C@stano14';
 ...
 /**
  ...
  public function IsSendmail() {
    if (!stristr(ini_get('sendmail_path'), 'sendmail')) {
      $this->Sendmail = '/etc/mail/sendmail.cf';
    }
